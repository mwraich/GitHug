...
## Contributors
Mandeep Wraich(https://github.com/mwraich), Ann Marie Doyle(https://github.com/amdoyle), Miranda Gagnon(https://github.com/mirandagagnon) and Natalie Doak(https://github.com/ndoak) 

Getting Started
If you're using bundler, do the following to get started with GitHug!
