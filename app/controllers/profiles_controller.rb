class ProfilesController < ApplicationController
  ...
  def profile_params
    params.require(:profile)
          ...
          :birthday, :operating_system, :about_me, :tag_list, :phone_number, :notification_email,
          :notification_sms, languages_attributes:[:id, :language, :skill_level, :_destroy],
          images_attributes: [:id, :image, :image_cache, :_destroy, :remove_image], preferences_attributes:
